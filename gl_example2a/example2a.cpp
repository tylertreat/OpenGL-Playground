...
//
// This version is the same as example2, but uses a single buffer object
// with the color data following the position data.
//
...
void init()
{
  ...
  // color data starts at position sizeof(points)
